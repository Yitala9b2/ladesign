 ...
 */
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        let functions_all = Array.from(document.querySelector(".tabs__items_all").children);
        ...
        let arr = [ functions_all, flats, houses, commercials ];
        for (let i = 0; i < arr.length; i++) {
            var num = Array.from(arr[i]);
            if (0 != num.length) tabsLength1[i].innerHTML = num.length;
        }
        document.documentElement.clientWidth;
        document.documentElement.clientWidth < 991.98 && document.documentElement.clientWidth;
        document.documentElement.clientWidth;
        window.screen.width;
        ...
        createGrid(functions_all, allItems);
