    ...
    (() => {
        ...
        if (null != page) {
            ...
            function createGrid(item1, item2) {
                ...
                const startQueries = () => {
                    const MediaQueryNew = matchMedia("(max-width:991.98px)");
                    const ifMatchesChange = e => {
                        if (e.matches) {
                            if (1 == item1.length) item1[0].style.gridArea = "1 /1 /3/3";
                            if (2 == item1.length) {
                                item1[0].style.gridArea = "1 /1 /3/2";
                                item1[1].style.gridArea = "1 /2 /3/3";
                            }
                            if (3 == item1.length) {
                                item1[0].style.gridArea = "1 /1 /3/2";
                            ...
                            if (4 == item1.length) {
                                ...
                                item1[1].style.gridArea = "1 /2 /2/3";
                                item1[2].style.gridArea = "2 /2 /3/3";
                                item1[3].style.gridArea = "3/1/4/3";
                            }
                            if (5 == item1.length) {
                                item1[1].style.gridArea = "1 /2 /2/3";
                                item1[2].style.gridArea = "2 /2 /3/3";
                            ...
                            if (8 == item1.length) {
                                ...
                                item1[7].style.gridArea = "7/1/8/3";
                            }
                            if (9 == item1.length) {
                                item1[1].style.gridArea = "1 /2 /2/3";
                                item1[2].style.gridArea = "2 /2 /3/3";
                                ...
                                item1[4].style.gridArea = "3/2/4/3";
                                item1[5].style.gridArea = "4/1/6/3";
                                item1[6].style.gridArea = "6/1/7/2";
                                item1[7].style.gridArea = "6/2/7/3";
                                item1[8].style.gridArea = "7/1/9/3";
                            }
                            if (10 == item1.length) {
                                item1[1].style.gridArea = "1 /2 /2/3";
                                item1[2].style.gridArea = "2 /2 /3/3";
                                ...
                                item1[7].style.gridArea = "6/2/7/3";
                                item1[8].style.gridArea = "7/1/9/3";
                                item1[9].style.gridArea = "9/1/10/3";
                            }
                            if (item1.length > 10) {
                                item1[1].style.gridArea = "1 /2 /2/3";
                                item1[2].style.gridArea = "2 /2 /3/3";
                            ...
                            if (1 == item1.length) {
                                item2.style.gridTemplateColumns = "repeat(1, 1fr)";
                                item2.style.gridTemplateRows = "repeat(2, 275px)";
                                item1[0].style.gridRow = "1/3";
                                item1[0].style.gridColumn = "1/2";
                            }
                            if (2 == item1.length) {
                                item2.style.gridTemplateColumns = "repeat(2, 1fr)";
                                item2.style.gridTemplateRows = "repeat(2, 275px)";
                                item1[1].style.gridRow = "1/3";
                                item1[1].style.gridColumn = "2/3";
                            }
                            if (3 == item1.length) {
                                item2.style.gridTemplateRows = "repeat(2, 275px)";
                                item1[0].style.gridColumn = "1/3";
                                item1[1].style.gridColumn = "3/5";
                                item1[1].style.gridRow = "1/2";
                                item1[2].style.gridColumn = "3/5";
                                item1[2].style.gridRow = "2/3";
                            }
                            if (4 == item1.length) {
                                item2.style.gridTemplateRows = "repeat(2, 275px)";
                                item1[1].style.gridRow = "1/3";
                                item1[2].style.gridColumn = "3/5";
                                item1[2].style.gridRow = "1/2";
                                item1[3].style.gridColumn = "3/5";
                                item1[3].style.gridRow = "2/3";
                            }
                            if (5 == item1.length) {
                                item2.style.gridTemplateRows = "repeat(2, 275px)";
                                item1[2].style.gridColumn = "3/5";
                                item1[3].style.gridColumn = "3/5";
                                item1[1].style.gridArea = "1/2/3/3";
                                item1[2].style.gridArea = "1/3/2/5";
                                item1[3].style.gridArea = "2/3/3/4";
                                item1[4].style.gridArea = "2/4/3/5";
                            }
                            if (6 == item1.length) {
                                item2.style.gridTemplateRows = "repeat(2, 275px)";
                                item1[5].style.gridColumn = "3/5";
                                item1[5].style.gridRow = "2/3";
                            }
                            if (7 == item1.length) {
                            ...
                            if (8 == item1.length) {
                                item2.style.gridTemplateRows = "repeat(3, 275px)";
                                item1[2].style.gridArea = "1/3/2/4";
                                item1[3].style.gridArea = "1/4/2/5";
                                item1[4].style.gridArea = "2/2/3/3";
                                item1[5].style.gridArea = "2/3/4/5";
                                item1[6].style.gridArea = "3/1/4/2";
                                item1[7].style.gridArea = "3/2/4/3";
                            }
                            if (9 == item1.length) {
                                item2.style.gridTemplateRows = "repeat(4, 275px)";
                                item1[2].style.gridArea = "1/3/2/4";
                                item1[3].style.gridArea = "1/4/2/5";
                                item1[4].style.gridArea = "2/2/3/3";
                                item1[5].style.gridArea = "2/3/4/5";
                                item1[6].style.gridArea = "3/1/4/3";
                                item1[7].style.gridArea = "4/1/5/3";
                                item1[8].style.gridArea = "4/3/5/5";
                            }
                            if (10 == item1.length) {
                                item2.style.gridTemplateRows = "repeat(4, 275px)";
                                item1[2].style.gridArea = "1/3/2/4";
                                ...
                                item1[5].style.gridArea = "2/3/4/5";
                                item1[6].style.gridArea = "3/1/4/3";
                                item1[7].style.gridArea = "4/1/5/2";
                                item1[8].style.gridArea = "4/2/5/3";
                                item1[9].style.gridArea = "4/3/5/5";
                            }
                            if (item1.length > 10) {
                                item1[2].style.gridArea = "1/3/2/4";
                                item1[3].style.gridArea = "1/4/2/5";
                                ...
                                item1[8].style.gridArea = "4/2/5/3";
                                item1[9].style.gridArea = "4/3/5/5";
                                let oddLenght = Math.floor((item1.length - 1) / 2);
                                let Rows;
                                let numbers = [];
                                let oddLenght1 = oddLenght + 1;
                                for (let numbersLength = numbers.length; numbersLength < oddLenght1; numbersLength++) numbers.push(numbers.length);
                                const newnumbers = numbers.filter((item => item % 1 == 0 && item % 2 != 0));
                                if (oddLenght % 1 === 0 && oddLenght % 2 != 0) {
                                    function oddNumbers(array) {
                                        for (let i = 0; i < array.length; i++) {
                                            if (true) {
                                                Rows = array.indexOf(array[array.length - 2]) + 4;
                                                item2.style.gridTemplateRows = `repeat(${Rows}, 275px)`;
                                            }
                                            break;
                                        }
                                    }
                                    ...
                                    Rows = newnumbers.indexOf(newnumbers[newnumbers.length - 2]) + 4;
                                    item2.style.gridTemplateRows = `repeat(${Rows}, 275px)`;
                                }
                            }
                        }
        ...
        if (inputMasks.length) flsModules.inputmask = Inputmask("9 (999) 999-99-99").mask(inputMasks);
        ...
        function initSliders() {
            if (document.querySelector(".page2-mainSlider__slider")) new core(".page2-mainSlider__slider", {
            ...
            if (document.querySelector(".similar__slider")) new core(".similar__slider", {
                modules: [ Navigation, Pagination, Autoplay, Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
...
***************************************************************************** */
        ...
        if (PriceWrapper) {
            headerBackground.style.background = "#000";
            headerBackground.style.opacity = "0.8";
        }
        let costs = document.querySelector(".costs");
        if (costs) {
            costs.querySelector("#basic").onclick = function() {
                let boxFormRate = document.querySelector(".check");
                boxFormRate.style.display = "block";
                boxFormRate.innerHTML = "Выбран пакет Basic";
            };
            costs.querySelector("#pro").onclick = function() {
                let boxFormRate = document.querySelector(".check");
                boxFormRate.style.display = "block";
                boxFormRate.innerHTML = "Выбран пакет pro";
            };
            costs.querySelector("#exclusive").onclick = function() {
                let boxFormRate = document.querySelector(".check");
                boxFormRate.style.display = "block";
                boxFormRate.innerHTML = "Выбран пакет exclusive";
            };
        }
